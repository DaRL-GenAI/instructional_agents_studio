...
export function render(ctx) {
  ...
  const filter = select([['', 'All events'], ...['llm_call', 'tts_call', 'image_call', 'stage_done', 'edit', 'prompt_edit', 'approve', 'export', 'settings', 'textbook', 'video'].map(t => [t, t])], ui.filter, { style: 'width:220px' });
